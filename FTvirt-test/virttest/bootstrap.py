...
mandatory_programs = {'qemu': basic_program_requirements + ['gcc'],
                      ...
                      'v2v': basic_program_requirements,
                      'libguestfs': basic_program_requirements,
                      'FT_kvm': basic_program_requirements}
#end add
...
def create_subtests_cfg(t_type):
    ...
    for shared_file in shared_file_list:
        ...
        #ting test
        #sys.stdout.restore()
        #print "shared_file_name : ",shared_file_name,"\n\n\n"
        #print "t_type : ",t_type,"\n\n\n"
        #print "first_subtest[t_type]",first_subtest[t_type],"\n\n\n"
        #end test
